[Home](../README.md)
[Back](./cat.submitter.workflow.md)
### Pre-requisites
...
```
## clone adept-pass.finra-cat-submitter

```sh
$ git clone git@gitlab.xinthesys.org:adept/adept-paas/adept-paas.workflows/adept-paas.cat/adept-paas.finra-cat-submitter.git

$ cd adept-paas.finra-cat-submitter
$ npm install

```
## Running the submitter service
